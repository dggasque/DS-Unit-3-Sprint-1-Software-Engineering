"""
Script produces 'ACME CORPORATION OFFICIAL INVENTORY REPORT'
"""

from random import randint, sample, uniform
from acme import Product

# List to be randomly sampled from
...
def inventory_report(products):
    """
    Randomly generates inventory list of acme.Product() class objects and then 
